...
TransferRequestService transferRequestService;
	  ...
	  public TransferRequestDetails requestRideTransfer(@RequestParam(required = false) ParcelTypeEnum parcelType,
		                                	       ...
		                                	       @RequestParam(required = false, defaultValue = "false") Boolean liftAvailable) throws JsonProcessingException, FirebaseMessagingException {
	        ...
	        TransferRequestDetails rideTransfer = transferRequestService.requestRideTransfer(parcelType, carModel,
	                ...
	                height, serviceType, vendorPickupVehicle, helperRequired, helperCount, vehicleCategory, instantBooking, homeType, packingType, goodsType, fromFloor, liftAvailable);
	        return rideTransfer;
	  }
