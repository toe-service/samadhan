	...
	public void notifyVehicles(TransferRequestDetails request) throws FirebaseMessagingException {
	    ...
	    for (Vehicle vehicle : vehicles) {
			...
			Message message = Message
	                ...
	                .putData("serviceType", request.getServiceType() != null ? request.getServiceType().name() : "")
	                .putData("vehicleType", request.getVehicleType() != null ? request.getVehicleType().name() : "")
	                .putData("source", request.getSource())
                    .putData("destination", request.getDestination())
                    .putData("distanceKm", request.getDistanceKm() != null ? String.valueOf(request.getDistanceKm()) : "")
